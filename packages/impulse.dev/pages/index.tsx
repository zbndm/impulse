...
posthog.init('phc_1lQCwnRxodnRBSr9GQp3TNKghTx9N9bGheH5PiHtS5z',{api_host:'https://app.posthog.com'})`,
        ...
        <section className="flex flex-col items-center max-w-3xl mx-auto">
          <figure>
            ...
            <figcaption className="text-right">
              —{' '}
              <a target="_blank" href="https://twitter.com/krogovoy" rel="noreferrer">
      ...
      <footer className="bg-theme-accent mt-40 flex items-center px-10 flex-col gap-4 py-12 font-mono">
        ...
        <div>
          Made by{' '}
          <a target="_blank" href="https://twitter.com/krogovoy" className="font-bold" rel="noreferrer">
            @krogovoy
          </a>{' '}
          and{' '}
          <a target="_blank" href="https://twitter.com/IVolchenskov" className="font-bold" rel="noreferrer">
            @IVolchenskov
          </a>
        </div>
      </footer>
